...
from .serializers import (UserSerializer, CategorySerializer, ShopDetailSerializer,
                          ProductInfoSerializer, OrderItemSerializer,
                          OrderSerializer, ContactSerializer, UsersListSerializer, UserDetailSerializer,
                          ShopsListSerializer)
...
class UserDetailView(generics.RetrieveUpdateDestroyAPIView):
    '''детальное отображение модели User'''
    queryset = User.objects.all()
